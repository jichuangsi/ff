...
public class StockEntrustRecode  {
    ...
    private String businessStockHoldingId;
    ...
    public String getBusinessStockHoldingId() {
        return businessStockHoldingId;
    }

    public void setBusinessStockHoldingId(String businessStockHoldingId) {
        this.businessStockHoldingId = businessStockHoldingId;
    }
