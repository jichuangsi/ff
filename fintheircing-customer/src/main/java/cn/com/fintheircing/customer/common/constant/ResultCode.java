...
public class ResultCode {
	...
	public static final String LOGIN_OUT_FAILE = "登出失败";
	public static final String LOGIN_OUT_ERR = "登出错误,请检查是否重复登出";
	public static final String FORCE_LOGIN_OUT_ERR = "强制登出失败";
