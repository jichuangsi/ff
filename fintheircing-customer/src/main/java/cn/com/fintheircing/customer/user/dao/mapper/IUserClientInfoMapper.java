...
public interface IUserClientInfoMapper {
	...
	@Select("<script>select t1.login_name as loginName,t1.pwd,t2.displayname as displayname,t2.phone as phone,t2.`status` as `status` from user_client_login_info t1 " +
